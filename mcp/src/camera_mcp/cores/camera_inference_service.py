    ...
    def _build_messages_with_history(self, base64_image: str, mime_type: str) -> list:
        ...
        current_request = {
            ...
            "content": [
                ...
                {"type": "text", "text": "分析当前画面并根据哨兵模式控制策略决定是否需要调整摄像头。请仔细查看历史对话记录，了解之前的观察状态，一定要避免连续两次重复的旋转或变焦操作。注意严格输出指定格式。\n注意寻人策略：优先寻找穿蓝色衣服的人。如果找到穿蓝色的衣服的人，如果他在远处，则先放大焦距观察他的细节，如果在近侧，则缩小焦距观察整体。观察完之后，再去观察其他人。"},
            ],
        }
